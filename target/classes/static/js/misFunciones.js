...
//                category:$("#category").val()
    ...
    if (datos.owner == '' || datos.capacity == '' || datos.category == '' || datos.name == '' || datos.description == '') {
        ...
        let datosJson = JSON.stringify(datos);
        $.ajax({
            url: 'http://193.123.116.21:8080/api/Partyroom/update',
            data: datosJson,
            type: 'PUT',
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
function actualizarC() {
    ...
    if (datos.name == '' || datos.email == '' || datos.age == '' || datos.password == '') {
        ...
        let datosJson = JSON.stringify(datos);
        $.ajax({
            url: 'http://193.123.116.21:8080/api/Client/update',
            data: datosJson,
            type: 'PUT',
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
function actualizarM() {
    ...
    if (datos.messagetext == '') {
        ...
        let datosJson = JSON.stringify(datos);
        $.ajax({
            url: 'http://193.123.116.21:8080/api/Message/update', //revisar
            data: datosJson,
            type: 'PUT',
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
function actualizarAdm() {
    ...
    if (datos.name == '' || datos.email == '' || datos.password == '') {
        ...
        let datosJson = JSON.stringify(datos);
        $.ajax({
            url: 'http://193.123.116.21:8080/api/Admin/update',
            data: datosJson,
            type: 'PUT',
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
...
//                reserva:$("#reserva").val()
    ...
    if (datos.mensaje == '' || datos.reserva == '' || datos.calificacion == '') {
        ...
        let datosJson = JSON.stringify(datos);
        $.ajax({
            url: 'http://193.123.116.21:8080/api/Score/update',
            data: datosJson,
            type: 'PUT',
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
